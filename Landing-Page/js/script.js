...
var checkPhoneNumber = document.getElementById("Check-phone");
...
function PhoneValidation() {
  ...
  if (phoneNumberlen < 1) {
    checkPhoneNumber.innerHTML = "Phone Number is required";
    return false;
  }
  if (phoneNumberlen !== 10) {
    checkPhoneNumber.innerHTML =
      "PhoneNumber should not be less than 10 digits";
    return false;
  }
...
function validateForm() {
  if (
    ...
    checkSubmit.innerHTML = "Please recheck the form and correct the errors";
    setTimeout(function () {
    ...
    checkSubmit.style.visibility = "visible";
    checkSubmit.style.marginLeft = "13px";
    checkSubmit.innerHTML = "Your details are successfully submitted";
    setTimeout(function () {
      checkSubmit.style.visibility = "hidden";
